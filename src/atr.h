 ...
 * @param [in,out] atr     where to store the ATR. Should be big enough.
 * @param [in,out] atr_len Length of \a atr
 *
 * @return
 */
int get_atr(enum atr_modulation modulation, const unsigned char *in, size_t inlen, unsigned char *atr, size_t *atr_len);
